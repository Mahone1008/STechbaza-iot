...
**Статус:** код у `main`; усі 28 тестів пройдено в GitHub Actions без пропусків. Локальне підтвердження користувача очікується.
...
Це автоматична перевірка програмного стенда. Локальна перевірка користувача
та фізичний ESP32/VFD мають окремий статус.
