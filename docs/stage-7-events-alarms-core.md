...
Перед продовженням операції 6 додано окремий блок [виправлень надійності та доступу](hardening-2026-09-25.md). Його локальна перевірка ще очікується; статус операції 6 не змінено.
